...
\textsc{\Large Computer Science \& Engineering}\\[0.5cm] % Major heading such as course name
% \textsc{\large Seminar eport}\\[0.5cm] % Minor heading such as course title
